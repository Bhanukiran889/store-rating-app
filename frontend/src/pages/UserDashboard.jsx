...
const UserDashboard = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${API_BASE_URL}/api/ratings/my`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
        const ratings = Array.isArray(response.data.ratings)
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-slate-700 dark:text-slate-300 mb-6">
        This is your personalized dashboard. Here you can view your profile
        details, manage your registered shops (if you are a store owner), and
        review the ratings you've submitted.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-md border border-slate-200 dark:border-slate-700">
          ...
          <div className="mt-4 flex gap-2">
            <Link
              to="/stores"
              className="bg-sky-600 hover:bg-sky-700 text-white font-semibold py-2 px-4 rounded-md shadow-sm transition-colors duration-200"
            >
              Browse Stores
            </Link>
          </div>
